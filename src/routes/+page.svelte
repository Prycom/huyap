...
КС-языки и регулярные языки будут рассматриваться подробно.
	...
	<h3 class="mt-4 text-2xl font-semibold">Виды распознавателей и их классификация</h3>

	<div>
		Распознаватели классифицируют в зависимости от вида <br/>
		составляющих их компонентов: <u>считывающего</u> устройства, устройства<br/>
		<u>управления</u> и внешней <u>памяти</u><br/>
	</div>
	<pre>
Считывающее устройство:
	<strong>Односторонние распознаватели</strong>
	...
	<strong>Двусторонние распознаватели</strong> 
	допускают перемещение считывающей головки в любом направлении.		

Устройства управления:
	<strong>Детерминированные</strong>
	<strong>Недетерминированные</strong>

Внешняя память:
	<strong>Без внешней памяти</strong>
	<strong>С ограниченной памятью</strong>
	<strong>С неограниченной памятью</strong>
</pre>
</div>
